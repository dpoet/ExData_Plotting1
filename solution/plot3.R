...
kFILE_NAME <- "plot3.png"
kPARAM_MARGIN <- c(5, 4, 4, 3)
kTARGET_VARIABLE_1 <- "Sub_metering_1"    
kTARGET_VARIABLE_2 <- "Sub_metering_2"
kTARGET_VARIABLE_3 <- "Sub_metering_3"
kYLABEL <- "Energy sub metering"
kTARGET_VARIABLES <- c("datetime", kTARGET_VARIABLE_1, kTARGET_VARIABLE_2, kTARGET_VARIABLE_3)
...
legend(
    "topright",
    , legend = c(kTARGET_VARIABLE_1, kTARGET_VARIABLE_2, kTARGET_VARIABLE_3)
